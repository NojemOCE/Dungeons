...
public class BoulderTest {
    ...
    public void boulderMovePlayerLeft(){
        // Create a new world
        World world = new World("boulder+player", "Standard", 1);
        try {
    ...
    public void boulderMoveThroughPortal() {
        // Create a new world
        World world = new World("portals-boulder", "Standard", 1);
        try {
    ...
    public void twoBoulderTest(){
        // Create a new world
        World world = new World("boulders", "Standard", 1);
        try {
    ...
    public void canRollOnSwitch(){
        // Create a new world
        World world = new World("player-boulder-switch", "Standard", 1);
        try {
