...
public class App {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Spark.post("/api/game/new/generate/", "application/json", (request,response) -> {
            return callUsingSessionAndArgument(request, (dmc) -> dmc.generateDungeon(Integer.valueOf(request.queryParams("xStart")), Integer.valueOf(request.queryParams("yStart")), Integer.valueOf(request.queryParams("xEnd")), 
            Integer.valueOf(request.queryParams("yEnd")), request.queryParams("gameMode")));
        }, gson::toJson);
